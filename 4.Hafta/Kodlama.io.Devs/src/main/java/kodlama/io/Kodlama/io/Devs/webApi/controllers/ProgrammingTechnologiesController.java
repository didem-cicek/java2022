...
public class ProgrammingTechnologiesController {
	...
	@PostMapping("/add")
	public void add(CreateProgrammingLanguageTechnologyRequest createProgrammingLanguageTechnology) throws Exception{
		programmingTechnologyService.add(createProgrammingLanguageTechnology);
	}

	@DeleteMapping("/delete")
	public void delete(DeleteProgrammingLanguageTechnologyRequest deleteProgrammingLanguage) throws Exception{
		programmingTechnologyService.delete(deleteProgrammingLanguage);
	}

	@PutMapping("/update")
	public void update(UpdateProgrammingLanguageTechnologyRequest updateProgrammingLanguage) throws Exception{
